...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="faneraForm" class="form-signin"
               enctype="multipart/form-data" action="addfanera?${_csrf.parameterName}=${_csrf.token}">
        ...
        <%--<spring:bind path="image">--%>
            <%--<div class="form-group ${status.error ? 'has-error' : ''}">--%>
                <input type="file" name="image" class="form-control"> ИзОображение </input>
