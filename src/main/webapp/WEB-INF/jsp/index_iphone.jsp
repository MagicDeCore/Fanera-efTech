...
<div id="hero">
    <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
        ...
        <div class="item" style="background-image: url(resources/assets/images/sliders/uoOwood/ldsp_1.jpg);">
            <div class="container-fluid">
                   <div class="caption vertical-center text-left">
                    <div class="big-text fadeInDown-1">
                        <!--Want a<span class="big"><span class="sign">$</span>200</span>Discount?-->
                       <span class="big"><span class="sign"></span></span>Ламинированная ДСП
                    </div>
...
<!--                    <div class="button-holder fadeInDown-3">
        ...
        <div class="item" style="background-image: url(resources/assets/images/sliders/uoOwood/dsp_2.jpg);">
            <div class="container-fluid">
                <div class="caption vertical-center text-left">
                    <div class="big-text fadeInDown-1">
                        <!--Want a<span class="big"><span class="sign">$</span>200</span>Discount?-->
                        <span class="big"><span class="sign"></span> </span>ДСП
                    </div>
...
<!--                    <div class="button-holder fadeInDown-3">
        ...
        <div class="item" style="background-image: url(resources/assets/images/sliders/uoOwood/fanera_3.jpg);">
            <div class="container-fluid">
                <div class="caption vertical-center text-left">
                    <div class="big-text fadeInDown-1">
                        <span class="big"><span class="sign"></span></span>Фанера
                    </div>
        ...
        <div class="carousel-holder" >
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <!--<a href="#">-->
                        <img alt="" src="resources/assets/images/uoObrands/rechica_logo.png" />
                    <!--</a>-->
                </div> 
                <!--/.carousel-item--> 
                <%----%>
